    ...
    limitedProducts.forEach(product => {
      ...
      productDiv.innerHTML = `
          ...
          <div class="product-info-wrapper">
            <div>
                <div class="product-stock-status">${product.availability}</div>
                <div class="product-price">${product.price} Kč</div>
            </div>
            <div class="add-to-card-btn"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9 22a1 1 0 1 0 0-2 1 1 0 0 0 0 2m11 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg></div>
          </div>
